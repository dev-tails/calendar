...
(() => {
  ...
  function EventDateSelect(event, onEventStateChange) {
    const el = Div({ styles: __spreadProps(__spreadValues({}, flexAlignItemsCenter), { padding: "12px" }) });
    ...
    function startTimeDateInputEl() {
      return Input({
        ...
        styles: __spreadProps(__spreadValues({}, inputStyles), { marginRight: "8px" })
      });
    }
    ...
    function endDateInputEl() {
      return Input({
        ...
        attr: {
          type: "date",
          value: event.end ? formatSplitDate(
    ...
    function onAllDayChange(e) {
      ...
      const dateStartInput = byId("start");
      const dateEndInput = byId("end");
      if (isChecked) {
        ...
        onEventStateChange({
          ...
          allDay: isChecked,
          end: event.end ? removeTime(event.end) : void 0
        });
      ...
      return __async(this, null, function* () {
        ...
        form.onsubmit = (e) => {
          ...
          if (eventState.allDay) {
            ...
            end3 = midnightEndDate;
          }
          setEventState({ start, end: end3 });
  ...
  function Event2(event) {
    ...
    function init2() {
      return __async(this, null, function* () {
        ...
        const isMultiDay = event.start.getDate() !== ((_b = event.end) == null ? void 0 : _b.getDate());
        if (event.allDay) {
          ...
          const dates = Div({
            styles: isMultiDay ? { display: "flex", alignItems: "flex-start" } : __spreadProps(__spreadValues({}, flexAlignItemsCenter), { width: "50%" })
          });
          const datesIcon = icon3(isMultiDay ? hourglassStart : calendarWeek);
          const startDate = Span({
            attr: {
              innerHTML: `${formatDateTime(
                isMultiDay ? __spreadValues(__spreadValues({}, dateTimeOptions), addTimeZoneOptions) : dateOptions,
                event.start
              )}`
            }
          });
